...
public class IncomeDetails implements java.io.Serializable {
  ...
  public void setOtherIncomeDescription(java.lang.String otherIncomeDescription) {
    this.otherIncomeDescription = otherIncomeDescription;
  }

  public IncomeDetails(java.lang.Long id, java.lang.String incomeType, java.math.BigDecimal fixedAmount,
      java.math.BigDecimal variableAmount, java.lang.String frequency, java.lang.String otherIncomeDescription) {
    this.id = id;
    this.incomeType = incomeType;
    this.fixedAmount = fixedAmount;
    this.variableAmount = variableAmount;
